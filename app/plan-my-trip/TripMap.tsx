...
const LAND_GEOJSON_URL = 'https://cdn.jsdelivr.net/gh/nvkelso/natural-earth-vector@master/geojson/ne_50m_land.geojson';
...
const ISLAND_LABELS = [
  { name: 'Salt Spring Island', lat: 48.82, lon: -123.50, minZoom: 9, kind: 'island' },
  { name: 'Galiano Island', lat: 48.92, lon: -123.44, minZoom: 9, kind: 'island' },
  { name: 'Mayne Island', lat: 48.85, lon: -123.29, minZoom: 10, kind: 'island' },
  { name: 'North Pender Island', lat: 48.78, lon: -123.29, minZoom: 10, kind: 'island' },
  { name: 'South Pender Island', lat: 48.75, lon: -123.22, minZoom: 10, kind: 'island' },
  { name: 'Saturna Island', lat: 48.78, lon: -123.13, minZoom: 10, kind: 'island' },
  { name: 'Prevost Island', lat: 48.83, lon: -123.38, minZoom: 11, kind: 'island' },
  { name: 'Thetis Island', lat: 49.00, lon: -123.69, minZoom: 10, kind: 'island' },
  { name: 'Penelakut Island', lat: 48.99, lon: -123.66, minZoom: 11, kind: 'island' },
  { name: 'Kuper Island', lat: 48.96, lon: -123.65, minZoom: 12, kind: 'island' },
  { name: 'Valdes Island', lat: 49.05, lon: -123.68, minZoom: 11, kind: 'island' },
  { name: 'De Courcy Island', lat: 49.10, lon: -123.73, minZoom: 12, kind: 'island' },
  { name: 'Mudge Island', lat: 49.13, lon: -123.78, minZoom: 12, kind: 'island' },
  { name: 'Gabriola Island', lat: 49.16, lon: -123.78, minZoom: 10, kind: 'island' },
  { name: 'Newcastle Island', lat: 49.18, lon: -123.94, minZoom: 12, kind: 'island' },
  { name: 'Protection Island', lat: 49.17, lon: -123.92, minZoom: 13, kind: 'island' },
  { name: 'Sidney Island', lat: 48.62, lon: -123.32, minZoom: 10, kind: 'island' },
  { name: 'Portland Island', lat: 48.72, lon: -123.37, minZoom: 11, kind: 'island' },
  { name: 'Moresby Island', lat: 48.70, lon: -123.30, minZoom: 12, kind: 'island' },
  { name: 'Piers Island', lat: 48.68, lon: -123.42, minZoom: 12, kind: 'island' },
  { name: 'James Island', lat: 48.61, lon: -123.36, minZoom: 12, kind: 'island' },
  { name: 'Bowen Island', lat: 49.38, lon: -123.37, minZoom: 10, kind: 'island' },
  { name: 'Keats Island', lat: 49.40, lon: -123.47, minZoom: 11, kind: 'island' },
  { name: 'Gambier Island', lat: 49.49, lon: -123.43, minZoom: 10, kind: 'island' },
  { name: 'Anvil Island', lat: 49.54, lon: -123.28, minZoom: 11, kind: 'island' },
  { name: 'Thormanby Islands', lat: 49.48, lon: -123.99, minZoom: 11, kind: 'island' },
  { name: 'Quadra Island', lat: 50.19, lon: -125.22, minZoom: 10, kind: 'island' },
  { name: 'Cortes Island', lat: 50.10, lon: -124.98, minZoom: 10, kind: 'island' },
  { name: 'Orcas Island', lat: 48.67, lon: -122.94, minZoom: 9, kind: 'island' },
  { name: 'Lopez Island', lat: 48.50, lon: -122.89, minZoom: 10, kind: 'island' },
  { name: 'San Juan Island', lat: 48.55, lon: -123.08, minZoom: 9, kind: 'island' },
  { name: 'Shaw Island', lat: 48.58, lon: -122.93, minZoom: 11, kind: 'island' },
  { name: 'Blakely Island', lat: 48.56, lon: -122.80, minZoom: 11, kind: 'island' },
  { name: 'Ganges', lat: 48.85, lon: -123.50, minZoom: 12, kind: 'place' },
  { name: 'Long Harbour', lat: 48.86, lon: -123.45, minZoom: 12, kind: 'place' },
  { name: 'Fulford Harbour', lat: 48.77, lon: -123.45, minZoom: 12, kind: 'place' },
  { name: 'Montague Harbour', lat: 48.89, lon: -123.40, minZoom: 12, kind: 'place' },
  { name: 'Lyall Harbour', lat: 48.80, lon: -123.18, minZoom: 12, kind: 'place' },
  { name: 'Winter Cove', lat: 48.80, lon: -123.20, minZoom: 13, kind: 'place' },
  { name: 'Otter Bay', lat: 48.81, lon: -123.31, minZoom: 12, kind: 'place' },
  { name: 'Port Browning', lat: 48.77, lon: -123.27, minZoom: 12, kind: 'place' },
  { name: 'Bedwell Harbour', lat: 48.75, lon: -123.23, minZoom: 12, kind: 'place' },
  { name: 'Hope Bay', lat: 48.82, lon: -123.28, minZoom: 13, kind: 'place' },
  { name: 'Telegraph Harbour', lat: 48.99, lon: -123.67, minZoom: 12, kind: 'place' },
  { name: 'Silva Bay', lat: 49.15, lon: -123.69, minZoom: 12, kind: 'place' },
  { name: 'Degnen Bay', lat: 49.13, lon: -123.73, minZoom: 13, kind: 'place' },
  { name: 'Tsehum Harbour', lat: 48.67, lon: -123.41, minZoom: 12, kind: 'place' },
  { name: 'Canoe Cove', lat: 48.68, lon: -123.41, minZoom: 13, kind: 'place' },
  { name: 'Princess Cove', lat: 49.00, lon: -123.55, minZoom: 13, kind: 'place' },
  { name: 'Pirates Cove', lat: 49.09, lon: -123.73, minZoom: 13, kind: 'place' },
  { name: 'Active Pass', lat: 48.87, lon: -123.31, minZoom: 11, kind: 'water' },
  { name: 'Porlier Pass', lat: 49.01, lon: -123.58, minZoom: 11, kind: 'water' },
  { name: 'Dodd Narrows', lat: 49.13, lon: -123.84, minZoom: 12, kind: 'water' },
  { name: 'Gabriola Passage', lat: 49.10, lon: -123.68, minZoom: 12, kind: 'water' },
  { name: 'Sansum Narrows', lat: 48.77, lon: -123.59, minZoom: 11, kind: 'water' },
  { name: 'Trincomali Channel', lat: 48.93, lon: -123.50, minZoom: 10, kind: 'water' },
  { name: 'Stuart Channel', lat: 48.93, lon: -123.70, minZoom: 11, kind: 'water' },
  { name: 'Swanson Channel', lat: 48.71, lon: -123.19, minZoom: 10, kind: 'water' },
  { name: 'Satellite Channel', lat: 48.72, lon: -123.49, minZoom: 10, kind: 'water' },
  { name: 'Saanich Inlet', lat: 48.62, lon: -123.50, minZoom: 10, kind: 'water' },
  { name: 'Navy Channel', lat: 48.83, lon: -123.27, minZoom: 12, kind: 'water' },
  { name: 'Plumper Sound', lat: 48.79, lon: -123.22, minZoom: 12, kind: 'water' },
  { name: 'Wallace Island Marine Park', lat: 48.95, lon: -123.55, minZoom: 12, kind: 'place' },
  { name: 'Montague Harbour Marine Park', lat: 48.89, lon: -123.41, minZoom: 13, kind: 'place' },
  { name: 'Beaumont Marine Park', lat: 48.75, lon: -123.22, minZoom: 13, kind: 'place' },
  { name: 'Cabbage Island', lat: 48.79, lon: -123.09, minZoom: 13, kind: 'island' }
];
  ...
  useEffect(() => {
    ...
    async function mountMap() {
      ...
      L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Reference/MapServer/tile/{z}/{y}/{x}', {
        ...
        className: 'plannerReferenceTiles'
      }).addTo(map);
...
function updateIslandLabels(L: any, map: any, layer: any) {
  ...
  ISLAND_LABELS
    ...
    .forEach((label) => {
      const className = `plannerIslandLabel plannerIslandLabel--${label.kind}`;
      L.marker([label.lat, label.lon], {
        ...
        icon: L.divIcon({
          className: '',
          html: `<div class="${className}">${escapeHtml(label.name)}</div>`,
          iconSize: [140, 26],
          iconAnchor: [70, 13]
        })
      }).addTo(layer);
