...
const ALL_MARKERS_OVERVIEW_MOBILE_LON_OFFSET = -0.35;
  ...
  if (showAllMarkersOverview) {
    ...
    map.setView(
      [
        ...
        center.lng + (isMobileOverview ? ALL_MARKERS_OVERVIEW_MOBILE_LON_OFFSET : ALL_MARKERS_OVERVIEW_DESKTOP_LON_OFFSET)
      ],
      zoom,
      { animate: false }
    );
